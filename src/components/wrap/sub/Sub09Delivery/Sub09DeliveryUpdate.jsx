...
export default function Sub09DeliveryUpdate(props) {
  ...
  const [state, setState] = useState({
    IDX: location.state.userID,
    userID: location.state.IDX,
    dName: "",
    dHP: "",
    dDefaultADR: "",
    dRequst: "",
  ...
  useEffect(() => {
    ...
    formData.append("INDEX", location.state.IDX);
    axios({
      url: "/hongo_sign_up/delivery_update_select.php",
      method: "POST",
      data: formData,
    })
      .then((res) => {
  ...
  const submitEvent = (e) => {
    ...
    axios({
      url: "/hongo_sign_up/delivery_update.php",
      method: "POST",
      data: formData,
    })
      .then((res) => {
